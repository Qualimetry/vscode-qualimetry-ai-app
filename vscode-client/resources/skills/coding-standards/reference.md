...
**Returns:** JSON object `{ "license": "...", "standards": [CodingStandard] }`.
...
All four tools return a licensed envelope:

```json
{
  "license": "string - proprietary licence notice governing use of the standards",
  "standards": [
    {
...
The `license` text reserves all rights to the customer organisation and Shazam Analytics Ltd. The standards may be used solely for generating, reviewing and analysing the customer's code; they must not be copied, shared or used for any other purpose.
